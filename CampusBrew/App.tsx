...
export default function App() {
  // GestureHandlerRootView must be the outermost component: the stack
  // navigator's gestures read the context it provides, and without it they
  // silently do nothing outside Expo Go.
  return (
