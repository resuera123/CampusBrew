      ...
      <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        ...
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <View style={[styles.inputContainer, { backgroundColor: '#F5F5F5' }]}>
            ...
            <TextInput style={[styles.input, { color: '#3A3A3A' }]} value={user?.fullName ? `${user.fullName.toLowerCase().replace(/ /g, '.')}@cit.edu` : ''} editable={false} />
          ...
          <View style={{ paddingTop: 24 }}>
            <TouchableOpacity style={[styles.button, loading && styles.buttonDisabled]} onPress={handleSave} disabled={loading} activeOpacity={0.8}>
